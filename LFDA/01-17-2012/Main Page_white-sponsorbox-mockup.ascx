...
<!-- Start Sponsor Image Rotation Code -->
    ...
    <script type="text/javascript">
        ...
        var rotator2 = {
            ...
            title: ["Stony Field Organic", "Thermo Fisher Scientific", "Stony Field Organic"]
        ...
        <div id="facebook_and_twitter">
            <div id="topLoginHeader">
				...
				<p style="color:#000000; ">
					...
					|
					<a style="text-align: center; color:#000000; padding:2px 0px 2px 0px;" href="http://townhall.livefreeordiealliance.org/main/authorization/signUp?" onclick="pageTracker._trackEvent('Top Buttons', 'Signup Click', 'signup');">Not a Member? Join for Free!</a> 
							...
							<div id="header-left">
							    ...
							    <div id="header-left-right">
							        ...
							        <div id="sponsor-thank-you">A Special Thank You to the Following Corporate Sponsors</div>
							         <div id="sponsor-box-bluewhiteBG">
							            <p>							                
							                <table>
							                <tr>
							                   <td >
